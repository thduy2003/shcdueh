  ...
  useEffect(() => {
    async function fetchData() {
      ...
      const response = await axios.get(
        `https://api.themoviedb.org/3/search/movie?api_key=631f00a19098cc0e85e78597345f9e30&query='${queryDebounce}'`
      );
  ...
  return (
    <div className="p-10">
      <div className="w-full max-w-[500px] mx-auto mb-20 ">
        <input
          className="w-full rounded-lg border-purple-500 p-5  border shadow-[0px_0px_0px_3px_rgba(125,_106,_255,_0.2);]"
          type="text"
